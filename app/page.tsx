...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-orange-500 selection:text-black">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl lg:max-w-4xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#about"
                className="inline-flex items-center justify-center rounded-xl border border-zinc-800 bg-zinc-900/30 px-8 py-4 text-base font-bold uppercase tracking-widest hover:bg-zinc-900 transition"
              >
                Explore The Method
              </a>
            </div>
      ...
      <section className="border-t border-zinc-900 bg-zinc-950 py-20 sm:py-28" id="about">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/30 p-8 hover:border-orange-500/20 transition-all group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Deceleration & Acceleration</h3>
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/30 p-8 hover:border-orange-500/20 transition-all group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">In-Game Conditioning</h3>
              <p className="text-zinc-400 leading-relaxed text-sm">
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-900/30 p-8 hover:border-orange-500/20 transition-all group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Engaging & Screamless Learning</h3>
              <p className="text-zinc-400 leading-relaxed text-sm">
      ...
      <section className="border-t border-zinc-900 bg-zinc-950/40 py-20 sm:py-28" id="services">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {services.map((service) => {
              const is1on1 = service.id === '33333333-3333-3333-3333-333333333331' || service.name.includes('1-on-1')
              const isGroup = service.id === '33333333-3333-3333-3333-333333333332' || service.name.includes('Small Group')
                ...
                >
                  ...
                  <div className="flex-1 p-8 flex flex-col justify-between">
                    ...
                    <Link
                      ...
                      className="w-full flex items-center justify-center rounded-xl bg-zinc-850 border border-zinc-850 px-4 py-3 text-sm font-bold uppercase tracking-wider text-white transition hover:bg-orange-500 hover:border-orange-500 hover:text-black"
                    >
                      Check Availability
                    </Link>
                  </div>
      ...
      <section className="border-t border-zinc-900 bg-zinc-950 py-20 sm:py-28" id="how-it-works">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-xs font-semibold uppercase tracking-widest text-orange-500 font-bold">Booking Process</h2>
            <p className="mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl text-white">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <span className="text-5xl font-black text-zinc-800">01</span>
                <div className="h-px bg-zinc-800 flex-1 hidden lg:block" />
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Select Program</h3>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <span className="text-5xl font-black text-zinc-800">02</span>
                <div className="h-px bg-zinc-800 flex-1 hidden lg:block" />
              </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <span className="text-5xl font-black text-zinc-800">03</span>
                <div className="h-px bg-zinc-800 flex-1 hidden lg:block" />
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Upload Receipt</h3>
              <p className="text-zinc-400 text-xs leading-relaxed">
                Send GCash payment and upload proof. No tedious reference numbers required.
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                <span className="text-5xl font-black text-zinc-800">04</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Start Training</h3>
              <p className="text-zinc-400 text-xs leading-relaxed">
                You receive a unique lookup code. Coach JP reviews payment screenshot and confirms.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* MEET COACH SECTION */}
      <section className="border-t border-zinc-900 bg-zinc-950/40 py-20 sm:py-28" id="coach">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-6 border-l-4 border-orange-500 pl-6 text-zinc-300 italic text-base leading-relaxed">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl border border-zinc-900 bg-zinc-900/60 p-8 shadow-2xl relative overflow-hidden">
                <div className="absolute right-0 top-0 h-24 w-24 rounded-full bg-orange-500/10 blur-xl" />
                <h3 className="text-base font-bold text-white mb-4">Training Guidelines</h3>
      ...
      {/* WHY NGP / TRUST */}
      <section className="border-t border-zinc-900 bg-zinc-950 py-20 sm:py-28" id="why-ngp">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-base font-bold text-white mb-1">US-Clinic Studied Methods</h4>
                <p className="text-zinc-400 text-xs leading-relaxed">
            ...
            <div className="flex gap-4">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-500/10 text-orange-500 text-sm font-bold flex-shrink-0">✓</span>
              <div>
                <h4 className="text-base font-bold text-white mb-1">Clear Court Billing</h4>
                <p className="text-zinc-400 text-xs leading-relaxed">
            ...
            <div className="flex gap-4">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-500/10 text-orange-500 text-sm font-bold flex-shrink-0">✓</span>
              <div>
                <h4 className="text-base font-bold text-white mb-1">Active Conditioning</h4>
                <p className="text-zinc-400 text-xs leading-relaxed">
      ...
      <section className="border-t border-zinc-900 bg-zinc-950/40 py-20 sm:py-28" id="reviews">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            {reviews.map((review, i) => (
              ...
              >
                ...
                <div className="mt-6 pt-6 border-t border-zinc-900/60 flex items-center justify-between">
                  ...
                  <span className="text-xs text-zinc-500 font-semibold uppercase tracking-wider">NGP Athlete</span>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* FINAL CTA SECTION */}
      <section className="relative overflow-hidden py-24 sm:py-32 border-t border-zinc-900">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-transparent z-0" />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-5xl uppercase">
            YOUR NEXT LEVEL STARTS WITH YOUR NEXT SESSION
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg text-zinc-400">
            Ditch outdated screamed drills. Choose your program, pick your schedule, upload GCash, and prepare for games with purpose.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 border-b border-zinc-900 pb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-xs text-zinc-500 font-semibold tracking-wide uppercase">
              ...
              <a href="#services" className="hover:text-zinc-300 transition">Programs</a>
              <a href="#coach" className="hover:text-zinc-300 transition">The Coach</a>
              <Link href="/booking/lookup" className="hover:text-zinc-300 transition">Lookup Booking</Link>
              <Link href="/admin/login" className="hover:text-orange-500 transition">Coach Portal</Link>
            </div>
          </div>

          <div className="mt-8 flex flex-col md:flex-row justify-between gap-4 text-xs text-zinc-600">
            <div>
