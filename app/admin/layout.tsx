  ...
  return (
    <div className="flex min-h-screen w-full max-w-full overflow-x-hidden bg-zinc-50 text-zinc-900 dark:bg-zinc-955 dark:text-white font-sans transition-colors duration-200">
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 border-r border-zinc-200 bg-white dark:border-zinc-900 dark:bg-zinc-900/40 backdrop-blur-xl">
        ...
        {/* User Card */}
        <div className="p-4 mx-4 my-6 rounded-xl bg-zinc-100 border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800 flex items-center gap-3">
        ...
        <div className="p-4 border-t border-zinc-200 dark:border-zinc-900 space-y-1">
          <button
            onClick={toggleTheme}
            className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold text-zinc-650 hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-455 dark:hover:bg-zinc-900 dark:hover:text-white transition-colors"
          >
        ...
        >
          ...
          <div className="border-t border-zinc-200 dark:border-zinc-900 pt-4 space-y-1">
            ...
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold text-zinc-655 hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-450 dark:hover:bg-zinc-900 dark:hover:text-white transition-colors"
            >
              <LogOut className="h-4 w-4" />
              Sign Out
            </button>
