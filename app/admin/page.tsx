                ...
                {todaySchedule.map((b) => (
                  <div key={b.id} className="rounded-lg border border-zinc-200 dark:border-zinc-800 p-4 space-y-2 bg-zinc-50 dark:bg-zinc-950/20">
                    ...
                    <div className="text-xs text-zinc-550 space-y-1">
                      <div className="flex items-center gap-1.5"><Zap className="h-3.5 w-3.5 text-orange-500" /> {b.services?.name}</div>
                      <div className="flex items-center gap-1.5"><MapPin className="h-3.5 w-3.5 text-blue-500" /> {b.courts?.name}</div>
                    </div>
                  </div>
                ))}
              </div>
